...
class App extends Component {
    ...
    renderContent() {
        return <div id="content">
            ...
            <Route path="/administeredEvents/:slug"
                   render={(props) => (<AdminEventDetail {...props} globalState={this.state} changeAppState={this.changeAppState}/>)}/>
            <Route path="/yourEvents"
                   render={(props) => (<SignedUpEvents {...props} globalState={this.state} changeAppState={this.changeAppState}/>)}/>
            <Route path="/create"
                   render={(props) => (<CreateEvent {...props} globalState={this.state} changeAppState={this.changeAppState}/>)}/>
